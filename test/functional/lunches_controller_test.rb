...
class LunchesControllerTest < ActionController::TestCase
  ...
  test "should create lunch" do
    assert_difference('Lunch.count') do
      post :create, lunch: { calories: @lunch.calories, contents: @lunch.contents, date: @lunch.date, price: @lunch.price }
    end
  ...
  test "should update lunch" do
    put :update, id: @lunch, lunch: { calories: @lunch.calories, contents: @lunch.contents, date: @lunch.date, price: @lunch.price }
    assert_redirected_to lunch_path(assigns(:lunch))
  end
